...
Label(root, text ='ENCRYPTED', font = 'arial 20 bold').pack(side =BOTTOM)
...
######result button
Button(root, font = 'arial 10 bold', text = 'RESULT'  ,padx =2,bg ='LightGray' ,command = Mode).place(x=140, y = 150)
